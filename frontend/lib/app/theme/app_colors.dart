...
abstract final class AppColors {
  ...
  /// 菜单选中态背景：品牌蓝 `#1677FF` 的 12% 透明度。
  ///
  /// 相比固定浅蓝底，这个颜色更轻、更通透，同时仍然跟随品牌主色。
  static const Color brandSelectedBackground = Color(0x1F1677FF);

  /// 菜单选中态边框：品牌蓝 `#1677FF` 的 20% 透明度。
  static const Color brandSelectedBorder = Color(0x331677FF);
