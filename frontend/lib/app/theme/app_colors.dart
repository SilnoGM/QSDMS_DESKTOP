...
abstract final class AppColors {
  ...
  /// 菜单选中态渐变起点：品牌蓝。
  static const Color brandSelectedGradientStart = brand;

  /// 菜单选中态渐变终点：链接蓝。
  static const Color brandSelectedGradientEnd = link;

  /// 菜单选中态阴影：品牌蓝 `#1677FF` 的 35% 透明度。
  static const Color brandSelectedShadow = Color(0x591677FF);

  /// 菜单悬停背景：品牌蓝 `#1677FF` 的 9% 透明度。
  static const Color menuHoverBackground = Color(0x181677FF);
